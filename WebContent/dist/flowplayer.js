...
flowplayer(function(player, root) {
   ...
   var conf = player.conf,
      ...
      target = common.createElement('div',{ 'class': 'fp-embed-code'}, '<label>Please Know where are the seconds.</label><textarea></textarea>'),
...
flowplayer(function(p, root) {
  ...
  var createSubtitleControl = function() {
    ...
    menu.appendChild(common.createElement('li', {'data-subtitle-index': -1}, 'Im Kyungsook'));
...
flowplayer(function(api, root) {
   ...
   // progress
      ...
      //멈춤
     	//var position = sessionStorage.getItem('stopTime');//세션에 멈춘 시간 등록한거 받아오기
      ...
      var duration2 = api.video.duration;//여기여기
