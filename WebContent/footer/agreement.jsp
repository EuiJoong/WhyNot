...
<p>제1조 [목적]</p>
<textarea rows="8" cols="130" readonly="readonly">
이 이용약관(이하 ‘약관’이라 합니다.)은 WhyNot(이하 ‘회사’라 합니다.)가 제공하는WhyNot(WhyNot.com) 및 WhyNot 관련 제반 서비스(이하 ‘서비스’라 한다.)를 이용고객(이하 ‘회원’이라 합니다.)
이용함에 있어 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.
</textarea>
...
– 서비스 : 구현되는 단말기와 상관없이 “회원” 혹은 웹사이트 방문자가 이용할 수 있는WhyNot 서비스를 의미합니다.
...
– 아이디(ID) : 회원의 식별 및 서비스 이용을 위하여 회원의 신청에 따라 회사가 회원 별로 부여하는 고유한 문자와 숫자의 조합을 말합니다.
...
– 가입 신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 단 “회사”의 회원 재가입 승낙을 얻은 경우에는 예외로 함.
...
<textarea rows="8" cols="130" readonly="readonly">
(1) “회원”은 개인정보관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 아이디, 이메일 등은 수정이 불가능합니다.
...
<p>제8조 [“회원”의 “아이디” 및 “비밀번호”, “이메일” 관리에 대한 의무]</p>
...
<p>제13조 [ 유료 서비스 거래 규정]</p>
<textarea rows="8" cols="130" readonly="readonly">
(1) 별도로 표시된 유료 서비스를 제외한 모든 서비스는 회원들에게 무료로 제공됩니다.
(2) 유료 서비스의 이용 요금 및 결제 방식은 해당 서비스에 명시되어 있는 규정에 따릅니다.
(3) 회원이 현금 및 사이버머니 등 거래에 필요한 내용을 확인하여 이에 승낙하면 거래가 성립된 것으로 간주합니다.
</textarea>

<p>제14조 [관계 법령상 환불 정책]</p>
<textarea rows="8" cols="130" readonly="readonly">
(1) 회사의 본 약관상 환불규정 등은 “약관의 규제에 관한 법률”, “온라인 디지털콘텐츠산업 발전법”, “전자상거래 등에서의 소비자보호에 관한 법률” 등을 준수합니다.
(2) 전 항의 관계법령에 따른 소비자의 청약철회가 불가능한 경우는 다음과 같습니다.
– 청약철회가 불가능한 콘텐츠에 대한 사실을 표시사항에 포함한 경우
– 시용상품을 제공한 경우
– 한시적 또는 일부 이용 등의 방법을 제공한 경우
(3) 회사는 본 조 제2항 제2호에 해당하는 사유인 ‘시용상품’을 제공하고 있으며 ‘무료강의&#8217; 등이 이에 해당합니다.
</textarea>

<p>제15조 [회사의 환불 규정]</p>
<textarea rows="8" cols="130" readonly="readonly">
(1) 회사는 회원의 편의를 위하여 전 조 제1항의 관계법령에도 불구하고 본 약관을 통하여 회원에게 좀 더 유리한 별도의 환불규정을 적용합니다.
(2) 회원은 환불 또는 변경을 유ㆍ무선의 방법을 통하여 회사에 그 의사를 표시하여야 하며, 회사는 환불요청을 접수하고 회원의 요청과 환불규정 확인 후, 최대한 신속하게 환불하여 드립니다.
(3) 회원은 다음 각 호의 사항에 따라 회사에 유료 콘텐츠 서비스의 환불 또는 변경을 요청할 수 있습니다. 단, 강의파일을 열거나 스마트폰, 스마트패드, PMP등 전자기기로 강의파일을 다운로드 받는 등의 행위는 1파일당 1강좌를 수강한 것으로 간주합니다.
(4) 회사의 환불 원칙은 다음과 같습니다.
– 5강 이상으로 구성된 강좌는 승인일로부터 2주 이내에 강좌맛보기를 제외한 2강 이하 수강 시에 환불을 요청하시면 전액환불이 가능합니다.
– 5강 미만으로 구성된 강좌는 승인일로부터 2주 이내에 1강 이하 수강 시에 환불을 요청하시면 전액환불이 가능합니다.
– 1강으로 구성된 개별강좌는 원칙적으로 환불이 불가능합니다.
– 특별강좌는 이벤트성 강좌, 비정규 강좌, 특별기획 강좌 등으로서 이는 별도의 수강 취소, 변경 및 환불규정이 적용될 수 있습니다.
– 환불조건에 부합하는 강좌를 타 강좌로 변경하는 경우, 직접 변경은 불가능하며 환불과 동일한 조건으로 회사가 운영하는 서비스 내에서 현금과 동일하게 사용할 수 있는 사이버머니로 충전하여 드립니다.
– 만20세 미만의 회원은 부모님과 통화 후 부모님 계좌로만 환불이 가능합니다.
– 신용카드 결제, 휴대폰 결제, 계좌이체 등 회원님이 결제한 수단과 동일한 방식으로 환불 하는 것을 원칙으로 합니다. 단, 부분 환불 등 환불이 불가능한 경우에 한해 회사가 운영하는 서비스내에서 현금과 동일하게 사용할 수 있는 사이버머니로 충전하여 드립니다.
(5) 회사의 환불 예외사항은 다음과 같습니다.
...
– 교재의 경우, 회원은 교재 수령 후 10일 이내에 회사에 반품의 의사표시를 하여야 하고, 수령 후 15일 이내에 해당 교재를 본사로 반환하여야 합니다. 단, 필기 및 훼손이 되지 않는 재판매가 가능한 상태일 경우에 환불 가능한 것을 원칙으로 합니다.
– 회원님의 변심에 의한 반품의 경우, 회원님이 반품비용을 부담하여야 합니다. 다만 파본/훼손된 교재가 배송될 경우 회사가 비용을 부담하여 교환 혹은 반품해 드립니다.
– 회사가 직접적으로 판매하는 교재 이외에, 회사 내 서비스 통해 링크된 사이트를 통해 구매된 교재의 경우, 해당 사이트의 환불규정에 따라 처리됩니다.
(6) 환불 과정에서 금융수수료가 발생하는 경우, 관련 법률에 따라 결제금액의 10%를 공제하고 환불할 수 있습니다.
(7) 4항에도 불구하고 “회사”는 신뢰도 제고나 이벤트를 위해 일시적으로 환불 조건을 완화할 수 있습니다.
</textarea>

<p>제16조 [서비스 제공의 변경 및 중지]</p>
<textarea rows="8" cols="130" readonly="readonly">
(1) 게시물이라 함은 회원이 서비스를 이용하면서 게시한 글, 사진, 각종 파일과 링크, 디지털 콘텐츠 등을 말합니다.
(2) “회사”는 무료로 제공되는 서비스의 일부 또는 전부를 회사의 정책 및 운영의 필요상 수정, 중단, 변경할 수 있으며, 이에 대하여 관련법에 특별한 규정이 없는 한 “회원”에게 별도의 보상을 하지 않습니다.
(3) 회사는 긴급한 시스템 점검, 증설 및 교체, 설비의 장애, 서비스 이용의 폭주, 정전, 국가비상사태, 천재지변 등 부득이한 사유가 발생한 경우 사전 예고 없이 일시적으로 서비스를 중지할 수 있습니다.
제17조 [회원의 게시물 등]
(1) 게시물은 회원이 서비스를 이용하면서 게시한 글, 사진, 각종 파일과 링크, 디지털 콘텐츠 등을 말합니다.
(2) 회원이 서비스에 등록하는 게시물 등으로 인하여 본인 또는 타인에게 손해나 기타 문제가 발생하는 경우 회원은 이에 대한 전적인 책임을 지게 되며, 회사는 이에 대하여 어떤 경우에도 책임을 지지 않습니다.
...
(4) 회사는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 삭제 할 수 있으며, 이의를 제기한 자와 게시물 등록자 간에 소송, 합의 등을 통해 당해 게시물에 관한 법적 문제가 종결된 후 이를 근거로 회사에 신청이 있는 경우에만 상기 임시 삭제된 게시물은 다시 등록될 수 있습니다.
(5) 회원이 이용계약해지를 한 경우 회원이 등록한 게시물은 자동 삭제되지 않으며 이용계약 해지 전에 직접 삭제를 하거나 요청을 할 경우 회사는 요청한 게시물을 삭제합니다.
</textarea>


<p>제18조 [게시물에 대한 저작권]</p>
<textarea rows="8" cols="130" readonly="readonly">
(1) 회사가 작성한 게시물 또는 저작물에 대한 저작권 기타 지적재산권은 회사에 귀속합니다.
(2) 회원이 서비스 내에 게시한 게시물의 저작권은 원칙적으로 게시한 회원에게 귀속됩니다. 단, 회사는 서비스의 운영, 전시, 전송, 배포, 홍보 등의 목적으로 회원의 별도의 허락 없이 무상으로 회원이 등록한 게시물을 사용할 수 있습니다.
(3) 회원이 올린 디지털 콘텐츠가 회원의 동의 없이 타인에 의해 무단, 불법 복제되어 회원뿐 아니라 회사의 이익에 상충할 경우 회사는 회원을 대리해 저작권을 행사할 수 있습니다. 단, 이 경우 회사는 회원에게 개별적 동의를 구합니다.
...
(3) “회원”이 계약을 해지하는 경우, “회원”이 작성한 “게시물”의 원본은 삭제됩니다.</p>
</textarea>
...
(4) 회원은 회사로부터의 본 조 제2항의 조치에 이의가 있는 경우, 회사의 법률 대리인을 통해 소명할 수 있습니다.
(5) 부정이용 식별방법 및 차단
– 회사는 회원의 서비스 이용 중에 수집ㆍ확인된 IP정보 등의 자료를 토대로, 서버를 통하여 부정이용 여부를 분류ㆍ확인합니다.
...
<p>제26조 [분쟁의 해결]</p>
<textarea rows="8" cols="130" readonly="readonly">
본 약관은 대한민국법령에 의하여 규정되고 이행되며, 서비스 이용과 관련하여 회사와 회원간에 발생한 분쟁에 대해서는 서울남부지방법원을 합의관할로 합니다.
</textarea>
...
<p>본 약관은 2016년 10월 6일부터 적용됩니다.</p>
</div>
<%@ include file="../top.jsp"%>