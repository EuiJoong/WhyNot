...
<div style="width: 80%; float: right;">
				...
				<c:if test="${size>0 }">
					<c:forEach var="noticeData" items="${listNotice }">
						<tr>
							...
							<td><a
								href="detailForAdmin.notice?ntnum=${noticeData.ntnum }&isEvent=1&eventnum=${noticeData.eventnum}">${noticeData.title }</a></td>
	...
	<a class="btn btn-primary" onclick="javascript:goInsertNotice()">공지사항
		등록</a>
</div>
