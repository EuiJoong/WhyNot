...
<c:set var="eventnumList" value="${eventnumList }" />
...
#topbody {
   ...
   -->
			<form name="tx_editor_form" id="tx_editor_form"
				action="insertPro.notice" method="post" accept-charset="UTF-8"
         ...
         -->
						<div id="tx_toolbar_basic" class="tx-toolbar tx-toolbar-basic">
							<div class="tx-toolbar-boundary">
								...
								<ul class="tx-bar tx-bar-left tx-group-font">
									...
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-btn-bg    tx-underline" id="tx_underline">
									...
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-slt-tbg    tx-forecolor" id="tx_forecolor">
								...
								<ul class="tx-bar tx-bar-left tx-group-align">
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-btn-lbg    tx-alignleft" id="tx_alignleft">
									...
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-btn-bg    tx-alignright" id="tx_alignright">
											<a href="javascript:;" class="tx-icon" title="오른쪽정렬 (Ctrl+/)">오른쪽정렬</a>
										</div>
									</li>
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-btn-rbg    tx-alignfull" id="tx_alignfull">
								...
								<ul class="tx-bar tx-bar-left tx-group-etc">
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-btn-lbg    tx-emoticon" id="tx_emoticon">
								...
								<ul class="tx-bar tx-bar-left">
									...
									<li class="tx-list">
										<div unselectable="on"
											class="       tx-btn-bg    tx-background" id="tx_background">
				...
				<div>
					투표 번호: <select name="eventnum">
						<option value="0">없음</option>
						<c:forEach var="eventnum" items="${eventnumList }">
							<option value="${eventnum }">${eventnum }</option>
						</c:forEach>
					</select>
				</div>
			</form>
