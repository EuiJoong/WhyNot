...
<div class="wrap"
	style="width: 80%; float: right; background-color: white;">
			...
			<table style="text-align: right; width: 80%;"> 
				<tr >
					<td><a class="btn btn-primary"
						onclick="javascript:goOtherEvents()">공지사항 목록</a> <a
						class="btn btn-primary" onclick="javascript:updateNotice()">수정</a>
						<a class="btn btn-primary"
						onclick="delete.notice?ntnum=${ndto.ntnum}">삭제</a></td>
				</tr>
			</table>
			<table style="width: 80%;" border="1">
				<tr style="height: 5em;">
					<th style="text-align: center;">${ndto.title }</th>
				</tr>
