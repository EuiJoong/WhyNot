...
<script
	src="${pageContext.request.contextPath}/daumeditor/js/editor_loader.js"
	type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
function imgchk() {
	if(document.f.profimage.value == ""){
		alert("첨부된 파일이 없습니다.");
		return false;
	}
	...
	<div class="row">
		...
		<div class="col-md-6">
			<img class="img-responsive"
				src="${pageContext.request.contextPath}/images/${proDto.imgname}"
			...
			<div class="form-group" style="margin: 10px;">
				<form action="profimage_merge.mypage" method="post" name="f"
					...
					<div class="col-md-3" style="margin-left: 0px; padding-left: 0px;">
						<button type="button" onclick="imgchk()"  class="btn btn-default btn-block">사진
							변경</button>
					</div>
		...
		<div class="col-md-6">
			<h3>
				소개<a class="pull-right" data-toggle="modal"
					data-target=".bs-example-modal-lg"
					style="background-color: transparent; font-size: 12px;">[수정]</a>
			</h3>
			<p>${pe.content }</p>
			<!-- 	<h3>바보의 연혁?</h3>
		 	<ul>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content" style="padding: 12px; text-align: center;">


			<form name="tx_editor_form" id="tx_editor_form"
				action="profitor.mypage" method="post" accept-charset="UTF-8">
			...
			-->
					...
					<div id="tx_canvas" class="tx-canvas">
						<div id="tx_loading" class="tx-loading"></div>
