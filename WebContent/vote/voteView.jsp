...
<body>
<c:set var="currpollList" value="${currpollList }" />
<div class="wrap">   
 <h2>${eventtitle } 투표 현황</h2>

  <div class="barGraph">
    <ul class="graph">
      <span class="graph-barBack">
      <c:forEach var="currpollListDTO" items="${currpollList }">
        <li class="graph-bar" data-value="${currpollListDTO.score }">
          <span class="graph-legend">${currpollListDTO.nominame }</span>
        </li>
      </span>  
	</c:forEach>
