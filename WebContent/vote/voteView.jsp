...
<body style="background-color: white;">
	...
	<div class="wrap">
		<table class="barGraph">
			<tr>
				<th colspan="2">${eventtitle }투표현황</th>
			</tr>
			<c:forEach var="currpollListDTO" items="${currpollList }">

				<tr class="graph">
					<td class="graph-legend">${currpollListDTO.nominame }</td>
					<td class="graph-bar" style="margin-left: 5em"
						data-value="${currpollListDTO.score }"></td>
				</tr>
			</c:forEach>
		</table>
