				...
				<div class="form-group ">
					...
					<div class="col-sm-10 text-padding">
						<label class="control-label float-left lable-position">제 목
							...
							placeholder="제목을 입력하세요."> <select name="ctnum" id="ctnum"
							class="selectpicker">
							<c:choose>
					...
					<div class="col-sm-10 text-padding">
						<label class="control-label float-left lable-position">가 격
							: </label> <input type="text" class="form-control" name="goal_amount"
							id="goal_amount" placeholder="목표금액"
						...
						<input type="text" class="form-control" name="min_amount"
							id="min_amount" placeholder="후원 최소금액"
							onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'
					...
					<div class="col-sm-10 text-padding">
						<label class="control-label float-left lable-position">기 간
							...
							class="form-control" placeholder="오늘 +7~30일"
							style="width: 200px;">
					</div>
					...
					<div class="col-sm-10 text-padding">
						<label
							class="control-label float-left lable-position text-padding">이미지
