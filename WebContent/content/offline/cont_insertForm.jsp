			...
			function() {
				$("#myModal").on(
						...
						function() {
							...
							var jsonObj = JSON.stringify($("#tx_editor_form")
									.serializeObject());
							console.log(jsonObj);
							sessionStorage.setItem("temp_value", jsonObj);
...
<script type="text/javascript">
	function initForm(){
		...
		var temp_value = JSON.parse(sessionStorage.getItem("temp_value"));
		console.log(temp_value);
		if(temp_value.title != null && temp_value.title != "") {
			document.getElementById("title").value = temp_value.title
		}
		if(temp_value.goal_amount != null && temp_value.goal_amount != "") {
			document.getElementById("goal_amount").value = temp_value.goal_amount
		}
		if(temp_value.min_amount != null && temp_value.min_amount != "") {
			document.getElementById("min_amount").value = temp_value.min_amount
		}
		if(temp_value.period != null && temp_value.period != "") {
...
<div id="topbody">
	...
	-->
		<form name="tx_editor_form" id="tx_editor_form"
			...
			<input type="hidden" name="mnum"
				value="${memberDTO.mnum }" />
			<input type="hidden" name="cr_num" value="${param.cr_num }"/>
			<div class="form-group ">
				...
				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position">제 목
						...
						style="float: left; padding-right: 10px; width: 450px"
						placeholder="제목을 입력하세요."> 
						<select name="ctnum" id="ctnum" class="selectpicker">
						<c:choose>
				...
				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position">가 격
						: </label> <input type="text" class="form-control" name="goal_amount" id="goal_amount"
						placeholder="목표금액" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'
						style="width: 215px; display: inline; padding-right: 15px; margin-right: 15px; ime-mode:disabled;">
					<input type="text" class="form-control" name="min_amount" id="min_amount"
						placeholder="후원 최소금액" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'
						style="width: 215px; display: inline; margin-right: 15px; ime-mode:disabled;">

				</div>

				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position">기 간
						: </label> <input type="text" id="calendar" name="period" readOnly
						class="form-control" placeholder="오늘 +7~30일" style="width: 200px;">
				</div>

				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position"
						style="margin: 0px 325px 10px 0px;">강의실 정보 </label>
					<div>
						<!-- Button HTML (to Trigger Modal) -->
						<a href="classroom_reserve.offcont" class="btn btn-default"
							data-toggle="modal" data-target="#myModal"
							style="margin-bottom: 10px;">강의실 대여</a>
						<!-- 					   	<button type="button" class="btn btn-default" style="margin-bottom: 10px;" id="reserveButton">강의실 대여</button><br/> -->

						<!-- Modal HTML -->
						<div id="myModal" data-backdrop="static" data-keyboard="false"
							class="modal fade">
					...
					<input type="text" class="form-control" name="addr" id="addr"
						...
						value="${param.max_num }" placeholder="최대인원" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'
			...
			-->
									...
									<div id="tx_richtextbox_menu"
										...
										<div class="tx-menu-footer">
											<img class="tx-menu-confirm"
												src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1"
												alt="" /> <img class="tx-menu-cancel" hspace="3"
												src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1"
												alt="" />
										</div>
									</div>
								</li>
					...
					<div id="tx_canvas" class="tx-canvas">
						<div id="tx_loading" class="tx-loading">
							<div>
								<img
									src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/loading2.png"
					...
					<div id="tx_resizer" class="tx-resize-bar">
						...
						<img id="tx_resize_holder"
							src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/skin/01/btn_drag01.gif"
						...
						<div id="tx_attach_box" class="tx-attach-box">
							<div class="tx-attach-box-inner">
								<div id="tx_attach_preview" class="tx-attach-preview">
									<p></p>
									<img
										src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/pn_preview.gif"
	...
	<script type="text/javascript">
		...
		function validForm(editor) {
			...
			if (document.tx_editor_form.goal_amount.value == null
					|| document.tx_editor_form.goal_amount.value == "") {
				alert("목표금액을 입력해 주세요.");
				tx_editor_form.goal_amount.focus();
				return false;
			}

			if (document.tx_editor_form.min_amount.value == null
					|| document.tx_editor_form.min_amount.value == "") {
				alert("후원 최소금액을 입력해 주세요.");
				tx_editor_form.min_amount.focus();
				return false;
			}
			
			if (document.tx_editor_form.period.value == null
					|| document.tx_editor_form.period.value == "") {
				alert("후원받을 기간을 선택해 주세요.");
				return false;
			}
			
			if (document.tx_editor_form.addr.value == null
					|| document.tx_editor_form.addr.value == "") {
				alert("강의실 정보를 모두 입력해 주세요");
				return false;
			}
