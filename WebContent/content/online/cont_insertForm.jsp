...
#topbody {
	...
	-->
			<form name="tx_editor_form" id="tx_editor_form"
				action="/test.content" method="post" accept-charset="utf-8"
			...
			-->
						...
						<div id="tx_canvas" class="tx-canvas">
							<div id="tx_loading" class="tx-loading">
								<div>
									<img src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/loading2.png" width="113"
							...
							<div id="tx_attach_box" class="tx-attach-box">
								<div class="tx-attach-box-inner">
									<div id="tx_attach_preview" class="tx-attach-preview">
										<p></p>
										<img src="${pageContext.request.contextPath}/daumeditor/images/icon/editor/pn_preview.gif" width="147"
