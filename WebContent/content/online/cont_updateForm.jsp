...
<c:forEach var="contData" items="${contList }">
	...
	-->
			<form name="tx_editor_form" id="tx_editor_form"
				action="cont_updatePro.oncont?ocnum=${contData.OCNUM}&mnum=${contData.MNUM }&ptnum=${contData.PTNUM}&vdnum=${contData.VDNUM}"
				...
				<div class="form-group ">
					...
					<div class="col-sm-10 text-padding">
						<label class="control-label float-left lable-position">제 목
							...
							value="${contData.TITLE }"> <select name="ctnum">
					...
					<div class="col-sm-10 text-padding">
						<label class="control-label float-left lable-position">가 격
							...
							name="price" placeholder="가격을 입력하세요." value="${contData.PRICE }">
					</div>
					...
					<div class="col-sm-10 text-padding">
						<label
							class="control-label float-left lable-position text-padding">동영상
