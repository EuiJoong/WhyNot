...
<c:set var="count" value="${count}" />
   <div align="center">
      ...
      <div align="left">
      <a href="insertFrom.requestboard?id=${memberDTO.id}&mnum=${memberDTO.mnum}">글쓰기</a> <b>총 [${count}]개의 글이 있습니다.</b>
      </div>
      <div align="left">
      <table border="1" width="90%">
         ...
         <tr>
            <td>${dto.bnum}</td>
            <td >
            <a href="content.requestboard?bnum=${dto.bnum}&mnum=${memberDTO.mnum}">
            ${dto.subject}</a>
            </td>
            <td>${dto.id}</td>
            <td>${dto.reg_date}</td>
