...
<div id="topbody">
	...
	-->
		<form name="tx_editor_form" id="tx_editor_form"
			action="updatePro.requestboard" method="post" accept-charset="UTF-8">
			<input type="hidden" name="mnum" value="${pushboardDAO.mnum}" />
			<input type="hidden" name="bnum" value="${pushboardDAO.bnum}" />
			<input type="hidden" name="id" value="${pushboardDAO.id}" />
			<div class="form-group ">
				...
				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position">제 목
						:</label> <input type="text" class="form-control" id="subject" name="subject" value="${pushboardDAO.subject}"
						style="float: left; padding-right: 10px" placeholder="제목을 입력하세요.">

				</div>
				
				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position">추 천
						:</label> <input type="text" class="form-control" id="push" name="push" value="${pushboardDAO.push}" readonly="readonly"
						style="float: left; padding-right: 10px" placeholder="제목을 입력하세요.">
	...
	<script type="text/javascript">
		...
		function validForm(editor) {
			...
			if (document.tx_editor_form.subject.value == null
					|| document.tx_editor_form.subject.value == "") {
				alert("제목을 입력해 주세요.");
				tx_editor_form.subject.focus();
				return false;
			}
