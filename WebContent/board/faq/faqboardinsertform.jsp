...
<form  name="f" action="faqboardinsert_pro.faq" method="post"  onsubmit="return chk_board()" >
<table class="table">
<tr>
<th>카테고리 선택</th>
<td>
...
<th>내용</th>
<td>
<textarea  name = "content" rows='10' cols='102' class="form-control"></textarea>
</td>
</tr>
<tr>
	<td colspan="2" align="right">
	<input type="submit" value="전송"  class="btn btn-default" >
	<input type="reset" value="다시 입력" class="btn btn-default">
</td>
</tr>
</table>
</form>
