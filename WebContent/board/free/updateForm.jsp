...
<div id="topbody">
	...
	-->
		<form name="tx_editor_form" id="tx_editor_form"
			action="updatePro.freeboard" method="post" accept-charset="UTF-8">
			<input type="hidden" name="mnum" value="${freeboardDAO.mnum}" />
			<input type="hidden" name="bnum" value="${freeboardDAO.bnum}" />
			<input type="hidden" name="id" value="${freeboardDAO.id}" />
			<input type="hidden" name="re_step" value="${freeboardDAO.re_step}" />
			<input type="hidden" name="re_level" value="${freeboardDAO.re_level}" />
			<div class="form-group ">
				...
				<div class="col-sm-10 text-padding">
					<label class="control-label float-left lable-position">제 목
						:</label> <input type="text" class="form-control" id="subject" name="subject" value="${freeboardDAO.subject}"
