...
public class ServerMain implements Runnable{
   ...
   public void run() {
         try {
            ...
            //"C:\\Users\\고경숙\\Desktop\\S_Kiss\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\WhyNot\\video\\
            String upDir = saveDir.getAbsolutePath()+"//video\\";
...
/*            String[] fileNameE=fileName.split("[.]");//0: 파일 네임, 1: 파일 확장자
            ...
            if(fileNameE.length>=2){
              ...
              String filedir=saveDir.getAbsolutePath()+"//video\\";
              System.out.println("filedir : "+filedir);
              System.out.println("filetitle : "+filetitle);
              File source = new File(saveDir.getAbsolutePath()+"//video\\"+filetitle+ext);
              File target = new File(saveDir.getAbsolutePath()+"//video\\"+filetitle+"mp4");//여기서 난수발생
